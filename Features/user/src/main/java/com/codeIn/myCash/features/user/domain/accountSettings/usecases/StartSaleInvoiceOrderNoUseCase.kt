...
class StartSaleInvoiceOrderNoUseCase @Inject constructor(private val repository: ValuesInvoiceSettingsRepository){
    suspend operator fun invoke(orderNo : String?) : InvoiceSettingsState {
        return repository.startSaleInvoiceOrderNo(orderNo)
    }
}