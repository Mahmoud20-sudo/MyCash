...
open class FirstStepCreationInvoiceViewModel @Inject constructor(
    ...
    private var _tax = prefs.getStringFlowForKey(AppConstants.TAX)
    ...
    init {
        ...
        launchIO {
            _tax.collect { value ->
                tax = value.toFloat().roundToInt()
            }
        }
    }

    fun setProductInCart(productsInCart: ProductsInCart?) {
        if (_selectedProductsInCart.value == null)
