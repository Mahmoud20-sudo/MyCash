package com.codeIn.myCash.ui.home.clients_vendors.pay_receipt
...
import com.codeIn.myCash.ui.home.invoices.payReceipt.PayReceiptViewModel
...
@AndroidEntryPoint
class PayReceiptInvoiceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            payInvoiceButton.setOnClickListener {
                var cashValue = cashPaidAmountEditText.text
                ...
                if (viewModel.paymentType.value == PaymentType.CREDIT_CARD ||
                    ...
                    val value = NumberHelper.persianToEnglishText(visaValue?:"0.0")
                    if (value.toDouble() > 0){
                        if (NFCChecker.checkNotPOSAndNFC(requireContext())) {
        ...
        viewModel.apply {
            paymentType.observe(viewLifecycleOwner) { type ->
                this@PayReceiptInvoiceFragment.updatePaymentType(type = type)
            }
