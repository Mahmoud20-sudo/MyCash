package com.codeIn.myCash.ui.authentication.sign_up.otp_verification
        ...
        lifecycleScope.launch {
            if (viewModel.registerType.value == RegisterType.FREE.value)
            {
                ...
                findNavController().run {
                    navigate(R.id.action_navigationOtpVerificationSignUpFragment_to_completeInfoFragment2
                        ,null, NavOptions.Builder().setPopUpTo(findNavController().graph.startDestinationId, true).build())
                }
                ...
                findNavController().run {
                    navigate(R.id.action_navigationOtpVerificationSignUpFragment_to_navigationSubscriptionsFragment,null, NavOptions.Builder().setPopUpTo(findNavController().graph.startDestinationId, true).build())
                }
            }
        }
    }
