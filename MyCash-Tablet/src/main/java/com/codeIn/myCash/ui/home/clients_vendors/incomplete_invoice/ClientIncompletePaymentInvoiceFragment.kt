package com.codeIn.myCash.ui.home.clients_vendors.incomplete_invoice
...
import com.codeIn.myCash.ui.home.invoices.incompleteInvoice.IncompletePaymentInvoiceViewModel
...
@AndroidEntryPoint
class ClientIncompletePaymentInvoiceFragment : Fragment() {
        ...
        binding.apply {
            ...
            showAllReceiptsTextView.setOnClickListener {
                findNavController().navigate(
                    com.codeIn.myCash.ui.home.clients_vendors.incomplete_invoice.ClientIncompletePaymentInvoiceFragmentDirections.actionClientIncompletePaymentInvoiceFragmentToSeeMoreReceiptsInvoiceFragment(
                ...
                when (response) {
                    ...
                    is ReceiptState.SuccessShowReceipts -> {
                        if (response.data?.data?.isEmpty() == true) {
                            ...
                            binding.receiptsCountTextView.text = "(${response.data?.data?.size?:0})"
    ...
    private val payReceiptCommunicator = object : PayReceiptDialog.Communicator {
        override fun onPay(model : CurrentReceiptModel , receipt: ReceiptModel) {
            ...
            findNavController().navigate(
                com.codeIn.myCash.ui.home.clients_vendors.incomplete_invoice.ClientIncompletePaymentInvoiceFragmentDirections.actionClientIncompletePaymentInvoiceFragmentToPayReceiptInvoiceFragment(
                    receipt, model
                )
            )
        }
