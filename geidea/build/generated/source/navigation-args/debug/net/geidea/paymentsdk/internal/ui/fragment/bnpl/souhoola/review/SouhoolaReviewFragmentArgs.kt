...
public data class SouhoolaReviewFragmentArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): SouhoolaReviewFragmentArgs {
      bundle.setClassLoader(SouhoolaReviewFragmentArgs::class.java.classLoader)
      val __step : Step?
      ...
      return SouhoolaReviewFragmentArgs(__step)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        SouhoolaReviewFragmentArgs {
      val __step : Step?
