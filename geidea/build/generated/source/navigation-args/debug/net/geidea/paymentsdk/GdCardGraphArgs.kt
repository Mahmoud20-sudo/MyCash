...
public data class GdCardGraphArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): GdCardGraphArgs {
      bundle.setClassLoader(GdCardGraphArgs::class.java.classLoader)
      ...
      return GdCardGraphArgs(__downPaymentAmount, __step)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): GdCardGraphArgs {
      val __downPaymentAmount : BigDecimal?
