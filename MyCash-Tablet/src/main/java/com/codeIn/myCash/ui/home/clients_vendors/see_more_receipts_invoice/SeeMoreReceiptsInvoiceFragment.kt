package com.codeIn.myCash.ui.home.clients_vendors.see_more_receipts_invoice
...
import com.codeIn.myCash.ui.home.invoices.seeMoreReceipts.SeeMoreReceiptsFragmentDirections
import com.codeIn.myCash.ui.home.invoices.seeMoreReceipts.SeeMoreReceiptsViewModel
...
@AndroidEntryPoint
class SeeMoreReceiptsInvoiceFragment : Fragment() {
    ...
    private val payReceiptCommunicator = object : PayReceiptDialog.Communicator {
        override fun onPay(model : CurrentReceiptModel , receipt: ReceiptModel) {
            ...
            findNavController().navigate(
                com.codeIn.myCash.ui.home.clients_vendors.see_more_receipts_invoice.SeeMoreReceiptsInvoiceFragmentDirections.actionSeeMoreReceiptsInvoiceFragmentToPayReceiptInvoiceFragment(
                    receipt, model
                )
            )
        }
