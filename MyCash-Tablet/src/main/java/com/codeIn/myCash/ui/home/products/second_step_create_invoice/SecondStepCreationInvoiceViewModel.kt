...
class SecondStepCreationInvoiceViewModel @Inject constructor(
    ...
    fun createClient(){
        launchIO {
            val type = if (selectedProductsInCart.value?.mainTypeInvoice?.value == MainTypeInvoice.PURCHASE.value)
    ...
    fun makeInvoice(cashPrice : String? , visaPrice : String? , date: String?){
       launchIO {
           ...
           makeInvoiceUseCase.invoke(
               ...
               products = selectedProductsInCart.value , paymentType = paymentType.value?.value ?: PaymentType.CASH.value
           ).let {
    ...
    fun confirmVisa(invoiceId : String?, runRefundInvoice : String? = null ,
                    codeRefundInvoice : String? = null, dateRefundInvoice : String? = null,){
        launchIO {
            confirmVisaUseCase.invoke(invoiceId,
