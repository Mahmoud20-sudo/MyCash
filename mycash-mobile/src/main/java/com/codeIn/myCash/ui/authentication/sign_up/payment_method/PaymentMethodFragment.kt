                ...
                when (response) {
                    ...
                    is GeneralResponse.Success -> {
                        findNavController().navigate(
                            com.codeIn.myCash.ui.authentication.sign_up.payment_method.PaymentMethodFragmentDirections.actionNavigationPaymentMethodFragmentToPaymentGatewayFragment(
