package com.codeIn.myCash.ui.options.help.viewmodel
...
/**
 * a view model class for [SubscriptionsFragment] fragment, it's used to handle the UI logic and prepare the data for the UI.
 */
@HiltViewModel
