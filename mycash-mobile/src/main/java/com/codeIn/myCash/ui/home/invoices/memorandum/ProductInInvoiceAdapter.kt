...
class ProductInInvoiceAdapter constructor(
    ...
    class ViewHolder(val binding: ItemProductDetailsInvoiceBinding) :
        ...
        fun bind(
            ...
            binding.apply {
                val unitPrice = NumberHelper.persianToEnglishText(item.price?:"0.0").toDouble().div(item.quantity?.toDouble() ?: 0.0)
                ...
                quantity.text = qty
                total.text = NumberHelper.persianToEnglishText(item.price?:"0.0")
            }
