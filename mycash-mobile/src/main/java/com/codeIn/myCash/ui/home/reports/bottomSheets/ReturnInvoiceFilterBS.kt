...
class ReturnInvoiceFilterBS  (private val context: Context) : OnDateSetListener {
        ...
        binding.apply {
            ...
            dateFromEt.setOnClickListener {
                datePicker = DatePickerDialog(
                    context, R.style.datePicker, this@ReturnInvoiceFilterBS,
