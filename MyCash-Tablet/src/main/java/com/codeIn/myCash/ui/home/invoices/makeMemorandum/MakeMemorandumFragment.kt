...
@AndroidEntryPoint
class MakeMemorandumFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            anotherProductTextView.setOnClickListener {
                navigateTo(com.codeIn.myCash.ui.home.invoices.makeMemorandum.MakeMemorandumFragmentDirections.actionNavigationCreditorDebtorNoteFragmentToNavigationAddNoticeProductsFragment())
            }
        ...
        viewModel.apply {
            ...
            invoiceModel.observe(viewLifecycleOwner) {
                ...
                if (it.products?.isNotEmpty() == true) {
                    initialProductsInInvoice(it.products as ArrayList<ProductInInvoiceModel>)
                }
            }
            ...
            memorandumType.observe(viewLifecycleOwner) {
                this@MakeMemorandumFragment.updateNoticeType(it)
            }
                    ...
                    is MemorandumState.SuccessValidationInput -> {
                        if (selectedProductsInMemorandum.value?.list?.isNotEmpty() == true){
                            if (viewModel.memorandumType.value == MemorandumType.DEBTOR)
                                navigateTo(
                                    com.codeIn.myCash.ui.home.invoices.makeMemorandum.MakeMemorandumFragmentDirections.actionNavigationCreditorDebtorNoteFragmentToNavigationInvoicePaymentFragment(
...
//            }
    ...
    private fun navigateTo(navDirections: NavDirections) {
        if (findNavController().currentDestination?.id == R.id.navigation_creditorDebtorNoteFragment) {
