...
class InvoiceReturnViewModel @Inject constructor(
    ...
    private val _selectedProductsInReturn = MutableLiveData(ProductInReturnInvoice())
    ...
    fun returnInvoice( cashPrice: String?,
        ...
        launchIO {
            returnInvoiceUseCase.invoke(cashPrice , visaPrice ,paymentType ,  selectedProductsInReturn.value ,
                ...
                codeRefundInvoice, runRefundInvoice, dateRefundInvoice , invoiceModel.value?.saleOrBuy?.toInt() ?:0
            ).let {
