package com.codeIn.myCash.ui.home.clients_vendors.memorandums
...
import com.codeIn.myCash.ui.home.invoices.memorandums.MemorandumsAdapter
import com.codeIn.myCash.ui.home.invoices.memorandums.MemorandumsViewModel
...
@AndroidEntryPoint
class ClientMemorandumsFragment : Fragment() {
                ...
                when (response) {
                    ...
                    is MemorandumState.SuccessShowSingleMemorandum ->{
                        findNavController().navigate(
                            com.codeIn.myCash.ui.home.clients_vendors.memorandums.ClientMemorandumsFragmentDirections.actionClientMemorandumsFragmentToClientMemorandumFragment(
