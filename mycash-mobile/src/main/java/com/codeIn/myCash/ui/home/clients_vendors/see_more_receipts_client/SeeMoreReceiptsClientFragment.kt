...
@AndroidEntryPoint
class SeeMoreReceiptsClientFragment : Fragment() {

    private val viewModel: SeeMoreReceiptsClientViewModel by viewModels()
    ...
    private val payReceiptCommunicator = object : PayReceiptDialog.Communicator {
        override fun onPay(model : CurrentReceiptModel , receipt: ReceiptModel) {
            ...
            findNavController().navigate(
                com.codeIn.myCash.ui.home.clients_vendors.see_more_receipts_client.SeeMoreReceiptsClientFragmentDirections.actionSeeMoreReceiptsClientFragmentToPayReceiptInvoiceFragment(
                    receipt, model
                )
            )
        }
