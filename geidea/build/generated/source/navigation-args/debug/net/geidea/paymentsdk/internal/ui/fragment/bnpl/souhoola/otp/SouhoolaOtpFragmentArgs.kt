...
public data class SouhoolaOtpFragmentArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): SouhoolaOtpFragmentArgs {
      bundle.setClassLoader(SouhoolaOtpFragmentArgs::class.java.classLoader)
      val __step : Step?
      ...
      return SouhoolaOtpFragmentArgs(__step)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): SouhoolaOtpFragmentArgs {
      val __step : Step?
