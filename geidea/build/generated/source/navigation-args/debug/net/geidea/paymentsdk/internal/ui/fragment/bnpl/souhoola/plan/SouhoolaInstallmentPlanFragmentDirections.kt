...
public class SouhoolaInstallmentPlanFragmentDirections private constructor() {
  private data class GdActionGdSouhoolainstallmentplanfragmentToGdSouhoolareviewfragment(
    public val step: Step,
  ) : NavDirections {
    public override val actionId: Int =
        R.id.gd_action_gd_souhoolainstallmentplanfragment_to_gd_souhoolareviewfragment
  ...
  private data class GdActionGdSouhoolainstallmentplanfragmentToGdPaymentoptionsfragment(
    public val downPaymentAmount: BigDecimal? = null,
    public val step: Step? = null,
  ) : NavDirections {
    public override val actionId: Int =
        R.id.gd_action_gd_souhoolainstallmentplanfragment_to_gd_paymentoptionsfragment
  ...
  public companion object {
    public fun gdActionGdSouhoolainstallmentplanfragmentToGdSouhoolareviewfragment(step: Step):
        NavDirections = GdActionGdSouhoolainstallmentplanfragmentToGdSouhoolareviewfragment(step)

    public
        fun gdActionGdSouhoolainstallmentplanfragmentToGdPaymentoptionsfragment(downPaymentAmount: BigDecimal?
        = null, step: Step? = null): NavDirections =
        GdActionGdSouhoolainstallmentplanfragmentToGdPaymentoptionsfragment(downPaymentAmount, step)
