...
public class TopSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public boolean onTouchEvent(CoordinatorLayout parent, V child, MotionEvent event) {
        ...
        if (mViewDragHelper != null && closable) {
            //no crash
...
//        mMaxOffset = mParentHeight - peekHeight;
    ...
    /**
     * Sets whether this top sheet should be closable or not
     */
     ...
     * after it is expanded once. SettingRepositoryModule this to true has no effect unless the sheet is hideable.
     *
