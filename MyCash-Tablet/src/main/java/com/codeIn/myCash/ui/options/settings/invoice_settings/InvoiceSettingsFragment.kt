    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            saveButton.setOnClickListener {
                ...
                viewModel.updateInvoiceSettings(
                    ...
                    productDescription = invoiceSettings?.productDesc,
                    clients = invoiceSettings?.client,
                    cashier = invoiceSettings?.cashier,
                    zatcaQr = invoiceSettings?.zatcaQr,
                    myCashQr = invoiceSettings?.myCashQr,
        ...
        viewModel.apply {
            dataResult.observe(
                ...
                when (response) {
                    is InvoiceSettingsState.Loading -> {}
                    ...
                    is InvoiceSettingsState.ServerError -> {}
