...
class DeviceSelectionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.nextButton.setOnClickListener {
            if (findNavController().currentDestination?.id == R.id.navigationDeviceSelectionFragment)
                findNavController().navigate(
                    com.codeIn.myCash.ui.authentication.sign_up.device_selection.DeviceSelectionFragmentDirections.actionNavigationDeviceSelectionFragmentToNavigationPaymentMethodFragment(
