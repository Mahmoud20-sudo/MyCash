...
import com.codeIn.myCash.databinding.DialogAddDiscountInvoiceBinding
...
class DiscountOptionsInInvoiceDialog @Inject constructor(
    context: Context,
    ...
    private lateinit var binding: DialogAddDiscountInvoiceBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DialogAddDiscountInvoiceBinding.inflate(layoutInflater)
        ...
        binding.apply {
            ...
            addButton.setOnClickListener {
                val discountValue = if(discountEditText.text.isEmpty()) "0" else NumberHelper.persianToEnglishText(discountEditText.text.toString())
