...
public class CardInputFragmentDirections private constructor() {
  private data class GdActionGdCardinputfragmentToGdCardauthfragment(
    public val finalPaymentData: PaymentData,
    public val step: Step? = null,
    public val cvv: String? = null,
  ) : NavDirections {
    public override val actionId: Int = R.id.gd_action_gd_cardinputfragment_to_gd_cardauthfragment
  ...
  public companion object {
    public fun gdActionGdCardinputfragmentToGdCardauthfragment(
      finalPaymentData: PaymentData,
      step: Step? = null,
      cvv: String? = null,
    ): NavDirections = GdActionGdCardinputfragmentToGdCardauthfragment(finalPaymentData, step, cvv)
