package com.codeIn.myCash.ui.home.expenses
...
import com.codeIn.myCash.databinding.FragmentTransactionsHostBinding

/**
 * A simple [Fragment] subclass.
 * Use the [TransactionsHostFragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 * This fragment is a host fragment for the ExpensesFragment. It is used to host the ExpensesFragment scenario in the navigation graph.
 *
 */
class TransactionsHostFragment : Fragment() {

    private lateinit var controller: NavController

    private var _binding: FragmentTransactionsHostBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTransactionsHostBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        controller = Navigation.findNavController(view.findViewById(R.id.transactions_nav_host_fragment))

    }


    /**
     * callback for the back button to handle the back button press when the user is in the transactions fragment
    ...
    private val destinationChangedListener =
        NavController.OnDestinationChangedListener { _, destination, _ ->
            if (destination.id != R.id.navigation_transactionsFragment) {
